...
func _ready():
	...
	spawnEnemyCluster(load("res://Assets/Enemies/habringer.tres"), 1, 0, -120, 100)
	spawnEnemyCluster(load("res://Assets/Enemies/ent_god.tres"), 1, 0, -280, 120)
	spawnEnemyCluster(load("res://Assets/Enemies/samurai.tres"), 1, 0, -280, 180)
	spawnEnemyCluster(load("res://Assets/Enemies/snake_god.tres"), 1, 0, -260, 240)
	spawnEnemyCluster(load("res://Assets/Enemies/shaman.tres"), 1, 0, 100, 280)
	spawnEnemyCluster(load("res://Assets/Enemies/alchemist.tres"), 1, 0, 60, 280)
